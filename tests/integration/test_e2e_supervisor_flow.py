...
class TestE2ESupervisorFlow:
    ...
    async def test_full_flow_with_one_retry(self, _mock_logger, temp_git_repo, test_config):
        ...
        async def mock_apply_session_patch(_client, _session_id, _iteration):
            ...
            worker.synchronizer.create_iteration_branch(patch_application_count)
    ...
    async def test_branch_state_during_flow(self, _mock_logger, temp_git_repo, test_config):
        ...
        async def mock_apply_session_patch(_client, _session_id, _iteration):
            ...
            worker.synchronizer.create_iteration_branch(apply_patch_count)
