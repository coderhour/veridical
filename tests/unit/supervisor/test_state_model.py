...
def test_loop_state_load_exists(repo_root: Path) -> None:
    ...
    state_json = '{"iteration": 1, "session_id": "test_session", "error_context": "test_error", "work_branch": "test_branch", "tasks_file": "tasks.md"}'
    ...
    assert state.tasks_file == Path(state_data["tasks_file"])
