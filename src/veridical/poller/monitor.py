...
from veridical.poller.backoff import BackoffStrategy, create_backoff_strategy
...
class Poller:
    ...
    def __init__(
        ...
        *,
        ...
        self.backoff = backoff_strategy or create_backoff_strategy(config.jules.backoff)
